...
# RussOdy.pl Todos os direitos reservados a Ecosistema
...
sub comenzar {
    ...
    $file =~ s/\s/ /g;
    print join "","[!] Lançando ",$max," Pacotes!\n";
    $file = "/".$file if($file !~ /^\//);
...
if($#ARGV > 2) {
	...
	die("______________________________________________________________\n                  RussOdy.pl by:RusSody \n______________________________________________________________\nUse: RusSody.pl [url] [Conexoes] [pedidos por conexao] [IP falco]\n* [URL]|Alvo\n* [conexoes]|Conexao\n* [pedidos por conexao]|Pacotes\n* [localhost]|ip 127.0.0.1\n______________________________________________________________\nEx: RusSody.pl http://www.pmdb.org.br 400 100 127.0.0.1\n");
}